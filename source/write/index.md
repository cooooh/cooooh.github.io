...
<div class="post-editor-card" id="post-editor">
  ...
  <details class="pe-token" id="pe-token-box">
    <summary>🔑 GitHub 令牌设置（首次使用必读）</summary>
    <ol>
...
<p class="pe-note">说明：令牌只保存在你当前浏览器，权限仅限本仓库的文章写入，可随时在 GitHub 撤销；草稿自动保存在本地浏览器，刷新不丢失。</p>
